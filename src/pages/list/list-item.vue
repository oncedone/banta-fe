<template>
    ...
    <view class="media-item view" v-if="options.title" @click="click">
        ...
        <view class="view">
            ...
            <view class="media-summary">{{ options.summary }}</view>
            <view
                v-if="options.image_list || options.image_url"
                class="image-section flex-row"
                :class="{
                    'image-section-right': options.article_type === 2,
                    'image-section-left': options.article_type === 1,
                }"
            ...
            >
                <image
                    class="image-list1"
                    :class="{
                        'image-list2': options.article_type === 1 || options.article_type === 2,
                    }"
        ...
        <view class="media-foot flex-row" style="flex-direction: row;">
            <view class="media-info flex-row" style="flex-direction: row;">
                ...
                <text class="info-text">{{options.publish_time}}</text>
            </view>
